	...
	<div class="container">
		...
		<div class="form-card">
			...
			<div class="form-title">
				...
				<p>Create and manage futuristic airline schedules</p>
				...
				<div class="form-grid">
					...
					<div class="input-box">
						...
						<label>Economy Price</label> <input type="number"
							name="economyTicketPrice" placeholder="Enter economy fare"
							required>
					...
					<div class="input-box">
						...
						<label>Business Price</label> <input type="number"
							name="businessTicketPrice" placeholder="Enter business fare"
							required>
